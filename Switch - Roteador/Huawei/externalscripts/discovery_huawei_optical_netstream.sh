...
WALK_OPTICAL=$(snmpwalk -v2c -c "$COMMUNITY" -t 3 -r 1 -p "$PORT" -On "$IP" "$OPTICAL_BASE" 2>/dev/null)
...
snmpwalk -v2c -c "$COMMUNITY" -t 3 -r 1 -p "$PORT" -On "$IP" 1.3.6.1.2.1.47.1.1.1.1.7 > "$TMPWALK/entname" 2>/dev/null &
snmpwalk -v2c -c "$COMMUNITY" -t 3 -r 1 -p "$PORT" -On "$IP" 1.3.6.1.2.1.31.1.1.1.1   > "$TMPWALK/ifname"  2>/dev/null &
snmpwalk -v2c -c "$COMMUNITY" -t 3 -r 1 -p "$PORT" -On "$IP" 1.3.6.1.2.1.2.2.1.2      > "$TMPWALK/ifdescr" 2>/dev/null &
snmpwalk -v2c -c "$COMMUNITY" -t 3 -r 1 -p "$PORT" -On "$IP" 1.3.6.1.2.1.31.1.1.1.18  > "$TMPWALK/ifalias" 2>/dev/null &
snmpwalk -v2c -c "$COMMUNITY" -t 3 -r 1 -p "$PORT" -On "$IP" 1.3.6.1.2.1.2.2.1.7      > "$TMPWALK/ifadmin" 2>/dev/null &
wait
